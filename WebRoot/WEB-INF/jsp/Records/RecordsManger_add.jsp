...
<link rel="stylesheet" href="style/select2/css/select2.min.css"
	type="text/css" />
...
<body style="min-height:200px;">
	...
	<form action="RecordsManger_add_submit.html">
		<input type="hidden" id="reStudentMoneny" name="reStudentMoneny" /> <input
			type="hidden" id="reTeacherMoney" name="reTeacherMoney" />
		<div class="panel">
			<div class="panel-head icon-bookmark">
				成果录入 <a style="color:blue" href="#">刷新</a>
			</div>
			<div class="panel-body">
				<div class="form-group">
					...
					<div class="field">
						<!-- <input id="reCompetitionCID" type="text" 
							name="reCompetition.cID" /> -->
